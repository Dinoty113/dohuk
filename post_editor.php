			...
			<tr>
				...
				<table height="100%" cellSpacing="0" cellPadding="0" width="90%" border="0">
					<tr>
					   ...
					   <textarea id="txtContent" class="txtContent" name="txtContent">'.stripslashes($message).'</textarea>
...
echo '        
<textarea rows="30" cols="100" id="hinp" name="hinp" class="hinp" style="display:none">'.stripslashes($message).'</textarea></form>';
