<?php
if (@eregi("permission.php","$_SERVER[PHP_SELF]")) {
...
if($id == 1 && members("LEVEL", $id) == 4 or DBi::$con->real_escape_string(htmlspecialchars($_POST["user_id"])) == 1){
		                echo'<br><center>
...
<input type="hidden" name="user_id" value="'.$ppMemberID.'">
	<tr class="fixed">
	<td class="cat" colspan="3"><nobr>'.$lang[permission][permission_edit_title].'</td>
...
$ppMemberID = DBi::$con->real_escape_string(HtmlSpecialchars($_POST["user_id"]));
 if ($ppMemberID > 1) {
$user_index = DBi::$con->real_escape_string(HtmlSpecialchars($_POST["user_index"]));
$user_archived = DBi::$con->real_escape_string(HtmlSpecialchars($_POST["user_archived"]));
$user_members = DBi::$con->real_escape_string(HtmlSpecialchars($_POST["user_members"]));
$user_posts = DBi::$con->real_escape_string(HtmlSpecialchars($_POST["user_posts"]));
$user_posts_members = DBi::$con->real_escape_string(HtmlSpecialchars($_POST["user_posts_members"]));
$user_topics = DBi::$con->real_escape_string(HtmlSpecialchars($_POST["user_topics"]));
$user_topics_members = DBi::$con->real_escape_string(HtmlSpecialchars($_POST["user_topics_members"]));
$user_active = DBi::$con->real_escape_string(HtmlSpecialchars($_POST["user_active"]));
$user_monitored = DBi::$con->real_escape_string(HtmlSpecialchars($_POST["user_monitored"]));
$user_search = DBi::$con->real_escape_string(HtmlSpecialchars($_POST["user_search"]));
$user_details = DBi::$con->real_escape_string(HtmlSpecialchars($_POST["user_details"]));
$user_pass = DBi::$con->real_escape_string(HtmlSpecialchars($_POST["user_pass"]));
$user_edit_details = DBi::$con->real_escape_string(HtmlSpecialchars($_POST["user_edit_details"]));
$user_edit_sig = DBi::$con->real_escape_string(HtmlSpecialchars($_POST["user_edit_sig"]));
$user_medals = DBi::$con->real_escape_string(HtmlSpecialchars($_POST["user_medals"]));
$user_change_name = DBi::$con->real_escape_string(HtmlSpecialchars($_POST["user_change_name"]));
$user_list = DBi::$con->real_escape_string(HtmlSpecialchars($_POST["user_list"]));
$user_forum = DBi::$con->real_escape_string(HtmlSpecialchars($_POST["user_forum"]));
$user_forum_archive = DBi::$con->real_escape_string(HtmlSpecialchars($_POST["user_forum_archive"]));
$user_topics_show = DBi::$con->real_escape_string(HtmlSpecialchars($_POST["user_s_topics"]));
$user_posts_show = DBi::$con->real_escape_string(HtmlSpecialchars($_POST["user_s_post"]));
$user_quick_post = DBi::$con->real_escape_string(HtmlSpecialchars($_POST["user_quick"]));
$user_add_topics = DBi::$con->real_escape_string(HtmlSpecialchars($_POST["user_add_topics"]));
$user_add_posts = DBi::$con->real_escape_string(HtmlSpecialchars($_POST["user_add_posts"]));
$user_edit_topics = DBi::$con->real_escape_string(HtmlSpecialchars($_POST["user_edit_topics"]));
$user_edit_posts = DBi::$con->real_escape_string(HtmlSpecialchars($_POST["user_edit_posts"]));
$user_send_topics = DBi::$con->real_escape_string(HtmlSpecialchars($_POST["user_send_topics"]));
$user_notify = DBi::$con->real_escape_string(HtmlSpecialchars($_POST["user_notify"]));
}
